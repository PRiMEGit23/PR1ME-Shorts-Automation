...
<script lang="ts" module>
	...
	export const PATHS = {
		...
		/* storyboard / workflow (2S4) */
		star: [
			'M12 4.5l2.2 4.9 5.3.6-4 3.8 1.1 5.3L12 16.5l-4.6 2.6 1.1-5.3-4-3.8 5.3-.6z'
		],
		camera: ['M4 8.5h3.5l1.5-2h6l1.5 2H20v9H4z', 'M12 11.5m-2.5 0a2.5 2.5 0 1 0 5 0a2.5 2.5 0 1 0-5 0'],
		'zoom-in': ['M11 11m-6.5 0a6.5 6.5 0 1 0 13 0a6.5 6.5 0 1 0-13 0', 'M16 16l4.5 4.5', 'M11 8v6', 'M8 11h6'],
		'zoom-out': ['M11 11m-6.5 0a6.5 6.5 0 1 0 13 0a6.5 6.5 0 1 0-13 0', 'M16 16l4.5 4.5', 'M8 11h6'],
		fit: ['M3.5 8V3.5H8', 'M16 3.5h4.5V8', 'M20.5 16v4.5H16', 'M8 20.5H3.5V16', 'M9 9v6M15 9v6M9 12h6'],
		copy: ['M9 9h11v11H9z', 'M5.5 15H4.5a1 1 0 0 1-1-1V4.5a1 1 0 0 1 1-1H14a1 1 0 0 1 1 1v1'],
		code: ['M9 6.5L3.5 12l5.5 5.5', 'M15 6.5l5.5 5.5-5.5 5.5'],
		chain: ['M9.5 14.5l5-5', 'M7.5 10.5L4.8 13a3.4 3.4 0 1 0 4.9 4.9l2.6-2.7', 'M16.5 13.5l2.7-2.7a3.4 3.4 0 1 0-4.9-4.9L11.7 8.6'],
		graph: ['M4.5 5h6v6h-6z', 'M13.5 13h6v6h-6z', 'M13.5 5h6v6h-6z', 'M4.5 13h6v6h-6z', 'M10.5 8h3', 'M10.5 16h3', 'M7.5 13v-2'],
		film: ['M3.5 6.5h17v11h-17z', 'M8 6.5v11M16 6.5v11', 'M6.5 9.5h.01M6.5 14.5h.01M17.5 9.5h.01M17.5 14.5h.01']
