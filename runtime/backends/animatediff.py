"""AnimateDiff adapter: SDXL-native animation backend."""
...
class AnimateDiffAdapter(BackendAdapter):
    """AnimateDiff: motion module on top of the SDXL pipeline."""
    ...
    def adapt(
        ...
        nodes["video"] = "animatediff motion module"
        nodes["frames"] = "16"
