"""GPT Image adapter: the highest prompt-adherence image model."""
...
class GPTImageAdapter(BackendAdapter):
    """GPT Image: adherence-first native model."""
